...
7. Визуальный ранг карточек (`CERT_TIERS`, шаг 10 баллов): 0–9 тотальный дефицит (рваный чек, штамп «БРАК»), 10–19 бюджетный стартап (крафт, «ТРЕБУЕТ ДОРАБОТОК»), 20–29 студенческий эконом (тетрадь, «СДАНО НА ТРОЙКУ»), 30–39 базовый городской («СТАНДАРТ-ПАКЕТ»), 40–49 твердый середняк («ОДОБРЕНО СЕМЬЕЙ»), 50–59 золотая середина (ГОСТ), 60–69 комфорт-плюс («ПРОВЕРЕННЫЙ ВЫБОР»), 70–79 бизнес-класс (сургуч APPROVED), 80–89 премиум / шейх-люкс (VIP SELECTION), 90–100 султанский джекпот. Индекс: `Math.min(9, Math.floor(rams / 10))`.
...
- Экспорт: селект формата + кнопка «Экспортировать результат» вызывают html2canvas / jsPDF без смещения шрифтов; ранг `CERT_TIERS` совпадает со шкалой; штамп не перекрывает рекламу и водяной знак; ссылка бота кликабельна в PDF.
