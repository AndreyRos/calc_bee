...
8. Шаринг (`shareResult`) открывает `t.me/share/url` с прямой ссылкой Mini App `https://t.me/calc_kalym_bot/app` (`BOT_CONFIG.url + '/app'`) и вирусным текстом рейтинга; вызов через `tg.openTelegramLink`, фоллбэк — `window.open`.

## 2. Диагностический чеклист

- Telegram SDK: window.Telegram.WebApp инициализирован, first_name подставлен; шаринг идёт в `t.me/share/url` со ссылкой `https://t.me/calc_kalym_bot/app`.
