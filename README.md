...
6. Результат экспортируется через селект формата: Stories 9:16 PNG, сертификат PNG или гербовый PDF с номером № БАРАН-XXXX-VIP и шкалой 0–100. На каждом документе водяной знак со ссылкой на бота (`BOT_CONFIG` → t.me/calc_kalym_bot) и рекламный баннер «Место для вашей рекламы».
